...
local path = "/usr/local/share/awesome/themes/zenburn/theme.lua"
beautiful.init(path)
...
foreachScreen(function (s)
	...
	wTaskList[s] = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, wTaskList.buttons)
	...
	local layBottombar = wibox.layout.align.horizontal()
	layBottombar:set_middle(wTaskList[s])

	bottombar[s]:set_widget(layBottombar)
end)
-- }}}
		...
		},
			{
				...
				client.connect_signal("manage", function (c, startup)
					...
					if c.type == "normal" or c.type == "dialog" then
						...
						if (default.titlebar.show == false) then
