-- Taken from https://github.com/meriadec/dotfiles/blob/master/config/awesome/modules/smart-borders.lua
--
-- Should give a client a special "border": 4 little corners offset'ed from the real corners
--
--  ####    ####
--  #          #
--  # ######## #
